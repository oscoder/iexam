...
class __Mustache_80ac82fee4ecd0e88171847eee02b51b extends Mustache_Template
{
...
';
        // 'page.news1' section
        $value = $context->findDot('page.news1');
        $buffer .= $this->section18cba84e7b9ca566ed40930fa767e512($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '                </tbody>
';
...
';
    ...
    private function section18cba84e7b9ca566ed40930fa767e512(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                        <td>';
                $value = $this->resolveValue($context->find('num'), $context, $indent);
